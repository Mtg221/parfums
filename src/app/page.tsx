...
export default function HomePage() {
  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      {/* 1. HERO SECTION (TEXT FOCUSED & ELEGANT, NO HERO BOTTLE IMAGE) */}
      <section className="relative pt-36 pb-20 overflow-hidden bg-gradient-to-b from-[#faf9f6] via-amber-50/30 to-[#faf9f6]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-amber-100/80 border border-amber-300/60 text-amber-900 text-xs font-semibold tracking-wider uppercase">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/catalogue"
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2.5 px-8 py-4 rounded-lg bg-amber-800 hover:bg-amber-900 text-white font-medium text-xs tracking-wider uppercase shadow-xs transition-colors"
            >
